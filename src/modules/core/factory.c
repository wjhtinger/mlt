...
extern mlt_consumer consumer_android_init( mlt_profile profile, mlt_service_type type, const char *id, char *arg );
...
MLT_REPOSITORY
{
	...
	MLT_REGISTER( consumer_type, "android", consumer_android_init );
