...
static mlt_profile backup_profile;

int video_start(int argc, char **argv)
{
	int i;
	...
	const char* repo_path = "/data/local/tmp/lib/mlt";
...
int video_get_position(void)
{
	return mlt_consumer_position(consumer);
}


int video_set_position(int position)
{
	return mlt_producer_seek(melt, position);
}


int video_set_speed(double speed)
{
	return mlt_producer_set_speed(melt, speed);
}
